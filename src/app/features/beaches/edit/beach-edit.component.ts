    ...
    this.beachService.getBeachById(id)
      .subscribe((data: Beach) => {
        ...
        this.beachForm = this.formBuilder.group({
          ...
          snorkeling_diving: [data.snorkeling_diving],
          kayak: [data.kayak],  
          discoteque: [data.discoteque],
          baby_parking: [data.baby_parking],
          costa_nord: [data.costa_nord],
          costa_sud:[data.costa_sud],
          costa_est:[data.costa_est],
          costa_ovest:[data.costa_ovest],
